...
class UAVPreparer:
    ...
    def run(self):
        ...
        # Access the vector layer
        self.layerComboManagerPoint = QgsMapLayerComboBox(self.dlg.widgetVector)
        ...
        self.layerComboManagerPointField = QgsFieldComboBox(self.dlg.widgetID)
    ...
    def savefile(self):
        ...
        self.dlg.lineEdit.setText(self.outputfile[0])

    def help(self):
        url = "https://github.com/AnnnaLH/UAVpreparer"
        webbrowser.open_new_tab(url)

    def start_progress(self):
        if not self.outputfile:
            QMessageBox.critical(None,"Error","Specify an output file")
            return #the code stops
        #Aquiring geodata and attributes
